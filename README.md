# Security Audit Assignment for fake toy company
...
The company deals with customer and eomplyee data and has different levels of access that needs to be regulated for internal and external access to only relevent information.
The manager expressed they wanted to comply with anything related to doing online business as well as business in Europe so they would need the following:
...
compromised, they must be informed within 72 hours of the incident.
